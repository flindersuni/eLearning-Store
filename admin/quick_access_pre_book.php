...
echo "<h2><span class='label label-danger'>Bookings for ".$e_date."</span></h2>";
...
echo "<td class=".$class."><a href='quick_access_book.php?barcode=".$barcode."&booking_id=".$row['booking_id']."&date_string=".$date_string."'><img src='../images/".$image.".jpg'></a></td>";
//echo $sql6;
...
if ($row['date_2']==$date) {
echo "<td class=".$class.">Due back today</td>";	
}else{

echo "<td class=".$class.">Until ".$e_date_2." </td>";//show reversed date 2
}
...
break;	
case 1:
    $status="<span class='glyphicon glyphicon-ok' aria-hidden='true' style='color:#d9534f'></span>";	
break;	
}
switch ($store_status) {
case 1:
